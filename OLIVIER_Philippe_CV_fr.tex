...
%% {\bf Présentation à la conférence IFORS 2017 (Québec, Canada)} \hfill Juil. 2017 \\
%% Solving the wedding seating problem by constraint programming

%% {\bf Stagiaire en informatique} \hfill Sept. 2014 -- Avr. 2015 \\
%% Hydro-Québec TransÉnergie, Montréal \\
%% {\sl Automatiser le transfert de données entre une base de données et un logiciel spécialisé}

%% {\bf Tuteur en informatique et mathématiques} \hfill Sept. 2013 -- Déc. 2013 \\
%% Université Laval, Québec \\
%% {\sl Cours de premier cycle en informatique et mathématiques}


%% NOTE: mettre des hyperliens pour les papers, etc.
...
\Gap\Gap
CPAIOR 2018 Paper (Springer Lecture Notes in Computer Science) \hfill (Pending)
...
\hfill
Juil. 2017
\begin{Detail}Solving the Wedding Seating Problem by Constraint Programming\end{Detail}
